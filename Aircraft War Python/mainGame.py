...
background = pygame.image.load('resources/image/space1.png').convert()
game_over = pygame.image.load('resources/image/over1.png')
...
while running:
    ...
    if not player.is_hit:
        ...
        if shoot_frequency >= 15:
            shoot_frequency = 0
    if 30000>score>=20000:
        k=40
    elif 50000>score>=30000:
        k=30
    elif 70000>score>=50000:
        k=20
    elif score>=70000:
        k=10
    elif 0<=score<20000:
